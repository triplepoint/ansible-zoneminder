# Ansible Zoneminder [![Build Status](https://travis-ci.org/triplepoint/ansible-zoneminder.svg?branch=master)](https://travis-ci.org/triplepoint/ansible-zoneminder)
